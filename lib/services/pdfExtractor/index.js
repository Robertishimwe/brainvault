...
function _extractTextFromPDF() {
  _extractTextFromPDF = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(pdfPath) {
    var data, pdf, text, i, page, content;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // Load the PDF file
          data = new Uint8Array(fs.readFileSync(pdfPath)); // Load the PDF document using pdfjs
          _context.next = 3;
          return pdfjs.getDocument(data).promise;
        case 3:
          pdf = _context.sent;
          // Create an empty string to store the extracted text
          text = ''; // Loop through each page in the PDF document
          i = 1;
        case 6:
          if (!(i <= pdf.numPages)) {
            _context.next = 17;
