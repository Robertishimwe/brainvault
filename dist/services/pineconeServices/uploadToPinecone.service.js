...
var _require = require('uuid'),
  uuidv4 = _require.v4;
var _require2 = require('../chunker/index'),
  splitText = _require2.splitText,
  createEmbeddings = _require2.createEmbeddings;
var _require3 = require('../pineconeServices/pinecone.service'),
  uploadToPinecone = _require3.uploadToPinecone;
var finalVector;
var uploadVector = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(newDataToUpload) {
    var chunks, vectors, batchedVector, doneUploading;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          chunks = splitText("".concat(newDataToUpload), 450);
        ...
        case 12:
          ...
          batchedVector = finalVector.splice(0, 350);
          _context.next = 16;
          return uploadToPinecone(batchedVector);
        case 16:
          doneUploading = _context.sent;
          if (!doneUploading) {
            _context.next = 20;
            break;
          }
  ...
  return function uploadVector(_x) {
