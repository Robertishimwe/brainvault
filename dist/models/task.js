...
var _email = _interopRequireDefault(require("../services/email/email.service"));
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import mongoose from "mongoose";
...
// Add a post update hook to send an email to the user of the updated task
taskSchema.post(['updateOne', 'updateMany'], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(result) {
    var updatedTasks, _iterator, _step, updatedTask, user, userEmail, email;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          _context.next = 11;
          return _mongoose["default"].model("User").findById(updatedTask.user);
        case 11:
          user = _context.sent;
          userEmail = user ? user.userEmail : ''; // Send an email to the user
          _context.next = 15;
          return (0, _email["default"])(userEmail, 'Your task has been updated', "Hi ".concat(user.userName, ",\n\n          Your task \"").concat(updatedTask.title, "\" has been updated.\n\n          Please click on the following link to view the updated task:\n\n          [Link to task]\n\n          Thanks,\n          The Team\n        "));
        case 15:
          email = _context.sent;
          console.log(email);
        case 17:
        ...
        case 29:
          ...
          console.error("Error sending email:", _context.t1);
        case 32:
        case "end":
          return _context.stop();
      }
    }, _callee, this, [[0, 29], [5, 21, 24, 27]]);
  }));
  return function (_x) {
